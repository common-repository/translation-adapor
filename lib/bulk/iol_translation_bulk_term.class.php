...
class Iol_Translation_Bulk_Term {
                        ...
                        <td class="colspanchange" colspan="9" id="iol_transaltion_bluk_colspanchange">
                            ...
                            <div class="iol_translation_table_flied">
                                ...
                                <div id="iol_translation_setting">
                                    <input type="hidden" id="iol_translation_obj_type" value="<?php echo $taxonomy; ?>">
                                    <p class="first_row">
                                        <input type="checkbox" class="translation_term_name" name="translation_term_name" value="1" style="margin-left: 0px;"><span style="margin-right: 10px;">Name</span>
                                    </p>
                            ...
                            <!--/transaltion setting-->
                            <p class="submit inline-edit-save" style="margin-top: 0px;">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function() {
                    ...
                    jQuery('#iol_transaltion_bluk_colspanchange .iol_translation_table_flied #iol_translation_go_quiry_btn').click(function(){
                        ...
                        if (jQuery("#iol_transaltion_bluk_colspanchange #iol_translation_setting .translation_term_name").is(":checked")){
                            var name = jQuery('#iol_transaltion_bluk_colspanchange #iol_translation_setting .translation_term_name').val();
                        }
                        ...
                        var taxonomy = jQuery('#iol_translation_obj_type').val();
                        ...
                        jQuery.ajax({
                            ...
                            success:function(data) {
                                ...
                                if(data.status == 'fails'){
                                    ...
                                    jQuery('#iol_transaltion_bluk_colspanchange #iol_translation_setting .third_row').show();
                                    if(data.show_info){
                                        jQuery('#iol_transaltion_bluk_colspanchange #iol_translation_setting .show_translation_info').html(data.show_info);  
                                    }
